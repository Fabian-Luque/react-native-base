...
import { Block, Button, Text } from "@components/Template";
        ...
        >
            <Block card flex={0} padding={sizes.sm} marginBottom={sizes.sm}>
                ...
                <Text align="justify" marginBottom={sizes.s}>
                    Are you looking for a modern mobile template to help you
                    speed up your development? Take a look at{" "}
                    <Text primary semibold>
                        {t("app.name")} {t("app.native")}
                    </Text>
                    , a gorgeous and innovative free template that will help you
                    create powerful mobile applications.
                </Text>
                <Text align="justify" marginBottom={sizes.s}>
                    The product is loaded with a big number of components (like
                    buttons, icons, cards, sections, example pages, and many
                    more) that will save you tons of time and money.
                </Text>
                <Text align="justify" marginBottom={sizes.sm}>
                    This product is the result of Creative Tim’s work, the
                    popular creator of both free and paid UI Kits and
                    Dashboards, helping over 1.5 million creatives from all over
                    the world.
                </Text>
                <Button
